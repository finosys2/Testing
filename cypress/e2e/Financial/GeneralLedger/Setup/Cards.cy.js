...
export function Save() {
    ...
    cy.visit('http://40.81.28.195:1110/Financials/Setup/Cards')
    cy.wait(1000);
    ...
    cy.wait(1000);
    cy.get('#CardList-CardCode').type(CardCode, {force: true}).blur()
    cy.wait(1000);
    cy.get('#CardList-CardType').click().get('[data-value="Employee"]')
    .click({force: true})
    cy.wait(1000);
    cy.get('#CardList-Phone-1').type(Phone1, {force: true}).blur()
    cy.wait(1000);
    cy.get('#CardList-CardName').type(CardName, {force: true}).blur()
    cy.wait(1000);
    cy.get('#CardList-Address').type(Address, {force: true}).blur()
    cy.wait(1000);
    cy.get('#CardList-Phone-2').type(Phone2, {force: true}).blur()
    cy.wait(1000);
    cy.get('#CardList-City').type(City, {force: true}).blur()
    cy.wait(1000);
    cy.get('#CardList-PostCode').type(PostCode, {force: true}).blur()
    cy.wait(1000);
    cy.get('#CardList-Email').type(Email, {force: true}).blur()
    cy.wait(1000);
    cy.get('#CardList-Country').type(Country, {force: true}).blur()
    cy.wait(1000);
...
export function Edit() {
    ...
    cy.wait(1000);
    cy.get('#CardList-CardName').clear()
    cy.get('#CardList-CardName').type(CardName)
    cy.wait(1000);
    cy.get('#CardList-Address').clear()
    cy.get('#CardList-Address').type(Address)
    cy.wait(1000);
    cy.get('#CardList-Email').clear()
    cy.get('#CardList-Email').type(Email)
    cy.wait(1000);
    cy.get('#CardList-Country').clear()
    cy.get('#CardList-Country').type(Country)
    cy.wait(1000);
    cy.get('#alert-dialog-slide-description > div > div > div:nth-child(2) > div > div > div > div > div:nth-child(12) > div > label > span.MuiCheckbox-root.MuiCheckbox-colorPrimary.MuiButtonBase-root.MuiCheckbox-root.MuiCheckbox-colorPrimary.PrivateSwitchBase-root.Mui-checked.css-wvbhqt-MuiButtonBase-root-MuiCheckbox-root > input')
    .click()
    cy.wait(1000);
    cy.get('.css-zw3mfo-MuiModal-root-MuiDialog-root > .MuiDialog-container > .MuiPaper-elevation24 > .MuiDialogActions-root > :nth-child(2)').click()
    cy.wait(7000);
...
export function Search() {
    cy.get('#CardCode').type('00')
    cy.wait(1000); 
    cy.get('#CardName').type('rimsha')
    cy.wait(1000); 
}
